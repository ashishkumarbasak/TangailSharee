...
abstract class PaymentGateway
{
    ...
    public function submitPayment()
    {
        ...
        echo "<html>\n";
        echo "<head><title>Processing Payment With Paypal</title></head>\n";
        ...
        echo "</form>\n";
        echo "<p style='padding-top: 200px; text-align: center; font-size:16px; font-family: Arial; color: #888;'>Please wait, we are processing your details<br /><br /><img src='http://twinne.com/images/animated_gif_twinne.gif'/></p></body></html>\n";
    }
