	...
	<?php }  ?>
      ...
      <div style="display: block;">
        <div class="top_button_box">
          <div class="top_button select1"><a style="background: #eee;" href="<?php echo base_url();?>user/manage_design/viewEarnings">Dashboard</a></div>
          <div class="point">:</div>
	  ...
	  $cur_year = date('Y',$time);
	   echo $cur_month.' '.$cur_year; ?></h1>
	   <?php $cur_balance = 0; $cur_sales = 0;
		foreach($results as $r){
			     $cur_balance +=$r['total_revenue'];
			     $cur_sales +=$r['total_sales'];
		}
		if($cur_balance > 0 && $cur_sales > 0){
	   ?>
	   
           <p>Current balance: <?php echo $cur_balance.'&pound;'; ?></p>
           <h3>LAST WEEK:</h3>
	   ...
	   <?php } ?>
                     ...
                     <h1><?php echo $last_date; ?></h1>
		     <?php if($last_revenue > 0) { ?>
                      <p>Current balance: <?php echo $last_revenue.'&pound;'; ?><span><?php if($payment_status=='Payment pending') { ?><img src="<?php echo base_url(); ?>images/watch.png" /><?php } elseif($payment_status=='Payment processed') { ?><img src="<?php echo base_url(); ?>images/right_icon.png" /><?php } echo $payment_status; ?></span></p>
		     <?php } else { ?>
		     <p>No sales in this month</p>
		     <?php } ?>
                    </div>
