...
<div id="wrapper">
  ...
  <div id="mid_content">
	...
	<li class="my_desigen selected"><a href="<?php echo base_url();?>user/manage_design/viewProducts">MY PRODUCTS</a></li>
	...
	<?php }  ?>
       ...
       <div style="display: block;">
        <div class="tab_mid_box3" id="tab_mid_box3">
				...
				<?php $this->load->view('user/list_of_member_products'); ?>
