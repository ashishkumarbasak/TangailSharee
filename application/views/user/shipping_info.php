...
<?php
	...
	echo str_replace("{profile_name}",$profile_name,lang('shipping_info'));
?>
</title>
...
$(document).ready(function(){
	...
	function validateAddressLine()
	{
		...
		if(address_line.val().length < 1){
			...
			address_line_error.text("Please input shipping address");
			return false;
		}
		//if it's valid
		else{
	...
	function validateCity()
	{
		...
		if(city.val().length < 1){
			...
			city_error.text("Please input shipping city");
			return false;
		}
		//if it's valid
		else{
	...
	function validateCountry()
	{
		...
		if(country.val().length < 1){
			...
			country_error.text("Please input shipping country");
			return false;
		}
		//if it's valid
		else{
  ...
  <div id="mid_content">
	...
	<?php } ?>
        ...
        <li class="wishlist"><a href="<?php echo base_url();?>user/member_wishlist">WISH-LIST</a></li>
         <?php if($this->session->userdata('contest')){ ?>
	...
	<?php }  ?>
      ...
      <div style="display: block;">
        <div class="top_button_box">
          ...
          <div class="point">:</div>
          <div class="shipping_in_button select1"><a href="<?php echo base_url();?>user/shipping_info">Shipping info</a></div>
          <div class="point">:</div>
        ...
        <?php 
			$attributes = array('name'=>'shippinginfoForm','id'=>'shippinginfoForm');
			echo form_open_multipart("user/shipping_info/saveShippingInfo",$attributes ); 
		?>
        <?php if(isset($user)){?>
        ...
        <div class="tab_mid_box">
        	<div class="tab_left_box">
                ...
                <?php if(isset($errors) && array_key_exists('address_line1',$errors)){?>
                	<div id="address_line1_error" class="error">Please input shipping address.</div>
                <?php }else{ ?>
                ...
                <div class="left_input_box">
                	...
                	<?php if(isset($errors) && array_key_exists('city',$errors)){?>
                		<div id="city_error" class="error">Please input shipping city.</div>
                	<?php }else{ ?>
                ...
                <div class="right_input_box">
                	...
                	<?php if(isset($errors) && array_key_exists('country',$errors)){?>
                		<div id="country_error" class="error">Please input shipping country.</div>
                	<?php }else{ ?>
