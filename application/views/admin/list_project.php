...
<div id="content">
	...
	<div id="page-heading">
		...
		<h1>PROJECTS<span><a href="<?php echo base_url();?>admin/project_manager/addProject">Add New</a></span></h1>
	</div>
	<!-- end page-heading -->
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<?php echo form_open('admin/project_manager/filter_index/',"name='filter_form' id='filter_form'"); ?>
				...
				<tr>
					...
					<th class="table-header-repeat line-left">Date Accepted</th>
    			...
    			<tr class="">
					...
					<td><input type='text' id='filter_date_accept' class='filter_input' /></td>
    		...
    		<?php $i=0; foreach($projects as $project){ ?>
				...
				<tr class="<?php echo $class;?>">
					...
					<td><?php echo $project->user->first_name.' '.$project->user->last_name; ?></td>
					<td><?php echo $project->status; ?></td>
					<td><?php if($project->date_added){echo date('d/m/Y',$project->date_added);} ?></td>
					<td><?php if($project->date_accept){echo date('d/m/Y',$project->date_accept); }?></td>
					<td class="options-width">
					<a href="<?php echo base_url();?>admin/project_manager/editProject/<?php echo $project->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="javascript:confirmDelete('<?php echo base_url();?>admin/project_manager/deleteProject/<?php echo $project->id; ?>')" title="Delete" class="icon-2 info-tooltip" ></a>
