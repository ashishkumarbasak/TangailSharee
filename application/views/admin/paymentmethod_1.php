...
<div id="page-heading"><h1>
 ...
 <!--Member taber Start-->
    <div id="vtab">
      <ul>
        <li class="home selected"><a href="<?php echo base_url();?>admin/setting_manager/paymentcredit">Authorize.net</a></li>
        <li class="home"><a href="<?php echo base_url();?>admin/setting_manager/paymentpaypal">Paypal</a></li>
        </ul>
...
<tr>
	...
	<tr valign="top">
	<td>
	<?php echo form_open("admin/setting_manager/paymentcredit"); ?>
		<input type="hidden" name="id" value="<?php if(isset($method->id)){echo $method->id;} ?>"/>
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form" style="float:left">
			<tr>
				<th>Enable/Disable</th>
				<td>:</td>
				<td>&nbsp;&nbsp;</td>
				<td><input type="checkbox" name='status' value="1" <?php if(isset($method->status) && $method->status==1){ echo "checked='checked'";} ?>/></td>
			</tr>
			...
			<tr>
				...
				<td></td>
				<td>
					<input type="text" name="name" id="name" value='<?php if(isset($method->name)){echo $method->name;}?>' />
					<?php echo form_error('name', '<div class="update_error">', '</div>'); ?>
				</td>
			</tr>
			<tr>
				<td></td>
				<td></td>
				<td><div class="button"><input type="submit" class="form-submit" value=""></div></td>
			</tr>
		</table>
     <?php echo form_close();?>   
    </td>
