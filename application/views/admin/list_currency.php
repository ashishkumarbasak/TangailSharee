		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">Short name</th>
					<th class="table-header-repeat line-left">Value</th>
    		...
    		<?php $i=0; foreach($currencies as $currency){ ?>
				...
				<tr class="<?php echo $class;?>">
					...
					<a href="<?php echo base_url();?>admin/currency_manager/editCurrency/<?php echo $currency->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="<?php echo base_url();?>admin/currency_manager/deleteCurrency/<?php echo $currency->id; ?>" title="Delete" class="icon-2 info-tooltip"></a>
