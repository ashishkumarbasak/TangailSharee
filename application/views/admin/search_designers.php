...
<tr>
	...
	<td>
		...
		<?php echo form_open("admin/report_manager/search_designer"); ?>
		<tr>
		...
		<tr>
			...
			<td>
				<select  id="filter_status" name="user">
					<?php foreach($user as $use){?>
						<option value="<?php echo $use->id; ?>"><?php echo $use->first_name.' '.$use->last_name;?></option>
					<?php } ?>	
				</select>
			</td>
			<td></td>
