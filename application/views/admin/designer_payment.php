		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">Month</th>
					<th class="table-header-repeat line-left minwidth-1">Total Sales</th>
					<th class="table-header-repeat line-left">Total Revenue</th>
					<th class="table-header-repeat line-left">Payment Status</th>
    		...
    		<?php $i=0; foreach($results as $result){ ?>
				...
				<tr class="<?php echo $class;?>">
					...
					<td><?php echo $result['total_revenue'].'&pound;'; ?></td>
					<?php if($result['payment'] == 'Payment pending') { ?>
						<td><?php echo form_open("admin/manage_designer/savePayment"); ?>
							<input type="hidden" value='<?php echo $designer->id;?>' name='designer_id' />
							<input type="hidden" value='<?php echo $result['month'];?>' name='month' />
							<input type="hidden" value='<?php echo $result['year'];?>' name='year' />
