...
<div id="page-heading"><h1>
 ...
 <!--Member taber Start-->
    <div id="vtab">
      <ul>
        <li class="home "><a href="<?php echo base_url();?>admin/report_manager/product_report">Product Report</a></li>
        <li class="home selected"><a href="<?php echo base_url();?>admin/report_manager/search_product">Advance Search</a></li>
        </ul>
