...
<?php
	 $bar='Edit Email Template';?>
<div id="page-heading"><h1><?php echo $bar;?></h1></div>
...
<tr>
	...
	<?php echo form_open("admin/email_setting/template_edit/1"); ?>
		<?php if(isset($email)){?>
			<input type="hidden" value='<?php echo $email->id;?>' name='id' />
		<?php }?>	
	...
	<td>
		...
		<tr>
			...
			<td><textarea name="template" id="content_body_1" ><?php if(isset($email)){ echo $email->template;} else {  echo $this->input->post('template'); }?></textarea>
			<?php echo display_ckeditor($ckeditor); ?>
			<td></td>
		</tr>
		<tr>
			<td></td>
			<td><input type="submit" class="form-update" value=""></td>
		</tr>
	<!-- <tr>
