...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>COUPONS<span><a href="<?php echo base_url();?>admin/coupon_manager/addCoupon">Add New</a></span></h1>
	</div>
	<!-- end page-heading -->
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">Code</th>
					<th class="table-header-repeat line-left minwidth-1">Discount</th>
    		...
    		<?php $i=0; foreach($coupons as $coupon){ ?>
				...
				<tr class="<?php echo $class;?>">
					...
					<td><?php if($coupon->type=='Fixed'){ echo '$'. $coupon->discount;} elseif ($coupon->type=='Percentage'){ echo $coupon->discount.'%' ;} else{ echo $coupon->type;}?></td>
					<td><?php echo date("d/m/Y",$coupon->start_date); ?></td>
					<td><?php echo date("d/m/Y",$coupon->end_date); ?></td>
					<td><?php if($coupon->status=='0'){ echo "Disabled"; }else{ echo "Enabled"; } ?></td>
					<td class="options-width">
					<a href="<?php echo base_url();?>admin/coupon_manager/editCoupon/<?php echo $coupon->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="javascript:confirmDelete('<?php echo base_url();?>admin/coupon_manager/deleteCoupon/<?php echo $coupon->id; ?>')" title="Delete" class="icon-2 info-tooltip" ></a>
