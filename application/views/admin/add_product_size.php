...
<?php
	 $button='Add Product Size';
	 $button1='Edit Product Size';
	 $bar='Add Size Details';
	 $bar1='Edit Size Details';
	 if (isset($psize)){
?>
...
<tr>
	...
	<td>
		...
		<?php echo form_open("admin/product_size_manager/savePsize"); ?>
			<?php if(isset($psize)){?>
				<input type="hidden" value='<?php echo $psize->id;?>' name='psize_id' />
			<?php }?>
		<tr>
		<th valign="top">Catagory:</th>
		<td>	
		<select  class="styledselect_form_1" name="catagory">
			
			<option value="man" <?php if (isset($psize) && $psize->catagory=='man'){ echo "selected='selected'";} ?>>Man</option>
			<option value="woman" <?php if (isset($psize) && $psize->catagory=='woman'){ echo "selected='selected'";} ?>>Woman</option>
		...
		<tr>
			...
			<td><input type="text" name="name" class="inp-form" value="<?php if(isset($psize)){ echo $psize->name;} ?>" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Description:</th>
			<td><textarea rows="" cols="" class="form-textarea" name="description"><?php if(isset($psize)){ echo $psize->description;} ?></textarea></td>
			<td></td>
		</tr>
