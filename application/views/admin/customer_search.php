...
<div id="page-heading"><h1>
 ...
 <!--Member taber Start-->
    <div id="vtab">
      <ul>
        <li class="home "><a href="<?php echo base_url();?>admin/report_manager/customer_report">Customer Report</a></li>
        <li class="home selected"><a href="<?php echo base_url();?>admin/report_manager/search_customer">Advance Search</a></li>
        </ul>
