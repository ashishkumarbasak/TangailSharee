...
<div id="page-heading"><h1>
 ...
 <!--Member taber Start-->
    <div id="vtab">
      <ul>
        <li class="home "><a href="<?php echo base_url();?>admin/report_manager/designer_report">Designer Report</a></li>
        <li class="home selected"><a href="<?php echo base_url();?>admin/report_manager/search_designer">Advance Search</a></li>
        </ul>
	...
	<td>
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">Sales</th>
				...
				<tr class="<?php echo $class;?>">
					...
					<td><?php echo $prod['no_of_products']; ?></td>
					<td><?php echo $prod['total_sale']; ?></td>
					<td><?php echo $prod['total_amount']; ?>&nbsp;&pound;</td>
					<td><?php echo $prod['total_revenue']; ?>&nbsp;&pound;</td>
