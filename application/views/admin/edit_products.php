...
<tr>
	...
	<td>
		<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
    		...
    		<?php $i=0; foreach($order->product as $prod){ ?>
	    		<?php if($i%2!='0'){
	    			$class="alternate-row";
	    		}else{
	    			$class="";
	    		...
	    		<tr class="<?php echo $class;?>">
					...
					<?php if($prod->join_id == $orderp->id){?>
						<td>
						<?php echo form_open("admin/sales_manager/saveEditedProduct"); ?>
							<input type="hidden" value='<?php echo $prod->join_id;?>' name='id' />
							<input type="text" value='<?php echo $prod->join_quantity;?>' name='quantity' />
					<?php }else{ ?></td>
