...
<?php
	 $button='Add Role';
	 $button1='Edit Role';
	 $bar='Add Role Details';
	 $bar1='Edit Role Details';
	 if (isset($role)){
?>
...
<tr>
	...
	<td>
		...
		<?php echo form_open("admin/role_manager/saveRole"); ?>
			<?php if(isset($role)){?>
				<input type="hidden" value='<?php echo $role->id;?>' name='role_id' />
			<?php }?>
		<tr>
			<th valign="top">Role Title:</th>
			<td><input type="text" name="name" class="inp-form" value="<?php if(isset($role)){ echo $role->name;} ?>" /></td>
			<td></td>
		</tr>
