...
<div id="page-heading"><h1>
 ...
 <!--Member taber Start-->
    <div id="vtab">
      <ul>
        <li class="home selected"><a href="<?php echo base_url();?>admin/report_manager/reward_report">Reward Points</a></li>
        <li class="home "><a href="<?php echo base_url();?>admin/report_manager/search_reward">Advance Search</a></li>
        </ul>
	...
	<td>
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">Reward Points</th>
					<th class="table-header-repeat line-left minwidth-1">Product Puchased with reward points</th>
				...
				<tr class="<?php echo $class;?>">
					<td><?php echo date("j-m-Y",strtotime($prod['date']));?></td>
					<td><?php echo $prod['points_used'];?></td>
