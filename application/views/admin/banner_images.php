...
<tr>
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0">
        <tr valign="top">
			...
			<td class="upload_right"><div class="step-dark-left1"><a href="<?php echo base_url();?>admin/setting_manager/banner_setting">Upload New</a></div></td>
        </tr>
            
        <tr>
            <td>
                <div  class="image_gallery">
                    <?php foreach($banner->file as $image){?>
                        		
                               <div  class="gallery_image"><img src="<?php echo base_url(); ?>images/banner_images/thumb_image/<?php echo $image->filename; ?>" />
                                    <a href="<?php echo base_url(); ?>admin/setting_manager/deleteBannerImage/<?php echo $image->id; ?>" >Delete</a>
                                </div>
                        <?php
                    } ?>
                </div>
