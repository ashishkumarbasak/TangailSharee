...
<?php
	 $button='Add New Post';
	 $button1='Edit Post';
	 $bar='Add Post Details';
	 $bar1='Edit Post Details';
?>
...
<tr>
	...
	<?php echo form_open("admin/post_manager/savePost"); ?>
	...
	<td class="table_left">
		...
		<tr>
			...
			<td><input type="text" name="name" class="inp-form" value="" /></td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="date"  id='start_date' value="" />
	...
	<div class="top-button">
	 <div class="button-1"><input type="submit" class="form-draft" value=""></div>
	 <div class="button-2"><input type="submit" class="form-preview" value=""></div>
	</div>
	<div class="clear"></div>
	...
	<select  class="styledselect_form_1" name="pcategory_id">
			<option value=""></option>
		</select>
	</div>
	<div class="clear"></div>
	<div>
	<div class="trash-link"><a href="#">move to trash</a></div>
	<div class="button"><input type="submit" class="form-publish" value=""></div>
	<div class="clear"></div>
	</div>
	</div>
	</td>
