...
<div id="content">
	...
	<div id="page-heading">
		<ul>
		  ...
		  <li class="select" ><a href="#">Published</a></li>
		  <li class="select" ><a href="#">Draft</a></li>
		 </ul>
		<div class="clear"></div>
		<h1>All Pages<span><a href="<?php echo base_url();?>admin/cms_manager/addPage">Add New</a></span></h1>
		...
		<div id="content-table-inner">
    		...
    		<?php $i=0; foreach($pages as $page){ ?>
				...
				<tr class="<?php echo $class;?>">
					...
					<a href="<?php echo base_url();?>admin/cms_manager/editPage/<?php echo $page->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="javascript:confirmDelete('<?php echo base_url();?>admin/cms_manager/deletePage/<?php echo $page->id; ?>')" title="Delete" class="icon-2 info-tooltip" ></a>
