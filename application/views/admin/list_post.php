...
<div id="content">
	...
	<div id="page-heading">
		...
		<h1>POSTS<span><a href="<?php echo base_url();?>admin/post_manager/addPost">Add New</a></span></h1>
	</div>
	<!-- end page-heading -->
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">Author</th>
					<th class="table-header-repeat line-left">Comments</th>
    		...
    		<?php $i=0; foreach($posts as $post){ ?>
				...
				<tr class="<?php echo $class;?>">
					...
					<td><?php echo $post->title; ?></td>
					<td><?php echo date("j/n/Y",$post->date); ?></td>
					<td class="options-width">
					<a href="<?php echo base_url();?>admin/post_manager/editPost/<?php echo $post->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
