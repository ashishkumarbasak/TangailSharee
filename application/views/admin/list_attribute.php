		...
		<div id="content-table-inner">
    		...
    		<?php $i=0; foreach($attributes as $attribute){ ?>
				...
				<tr class="<?php echo $class;?>">
					...
					<a href="<?php echo base_url();?>admin/attribute_manager/editAttribute/<?php echo $attribute->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="javascript:confirmDelete('<?php echo base_url();?>admin/attribute_manager/deleteAttribute/<?php echo $attribute->id; ?>')" title="Delete" class="icon-2 info-tooltip" ></a>
