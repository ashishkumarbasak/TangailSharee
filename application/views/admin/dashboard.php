...
<script type="text/javascript">
$(document).ready(function () {    
    $("#graph_select").bind("change", function () {
...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="weekgraph" style="width: 45%; min-height: 20px;float: right;">
				<img src="<?php echo base_url();?>/temp/week.png"/>
            </div>
            <div id="monthgraph" style="width: 45%; display:none; min-height: 20px;float: right;">
				<img src="<?php echo base_url();?>/temp/month.png"/>
            </div>
            <div id="yeargraph" style="width: 45%; display:none; min-height: 20px;float: right;">
				<img src="<?php echo base_url();?>/temp/year.png"/>
            </div>        
    		<div style="clear: both;"></div>
    		<div>
    			<h2>Daily Orders:</h2>
				...
				<tr>
                    ...
                    <th class="table-header-repeat line-left">Shipping Information</th>
					...
					<th class="table-header-repeat line-left">Hour Added</th>
					<th class="table-header-options line-left">Action</th>
				</tr>
    			
    		<?php 
			//print_r($order->all);
			$i=0; foreach($order->all as $ord){ 
			...
			?>
				...
				<tr class="<?php echo $class;?>">
                    ...
                    <td>
                    	...
                    	<?php echo $shipadd->address_line2;?> <br>
                    	<?php echo $shipadd->address_line3;?> <br>
                    	<?php echo $shipadd->city." ".$shipadd->postcode;?> <br>
                        <?php echo $shipadd->state." ".$shipadd->country;?> <br>
                    </td>
					<td><?php echo $ord->status;?></td>
					<td><?php echo $ord->quantity;?></td>
					<td><?php echo $ord->total_amount;?>&nbsp;
