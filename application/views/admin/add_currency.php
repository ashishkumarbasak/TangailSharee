...
<div id="page-heading"><h1>Add Currency</h1></div>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Add currency details</a></div>
		...
		<?php echo form_open("admin/currency_manager/saveCurrency"); ?>
			<?php if(isset($currency)){?>
				<input type="hidden" value='<?php echo $currency->id;?>' name='currency_id' />
			<?php }?>
		<tr>
			<th valign="top">Currency Name:</th>
			<td><input type="text" name="name" class="inp-form" value="<?php if(isset($currency)){ echo $currency->name;} ?>" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Short Name:</th>
			<td><input type="text" class="inp-form" name="short_name" value="<?php if(isset($currency)){ echo $currency->short_name;} ?>" /></td>
			<td></td>
		</tr>
                <tr>
			<th valign="top">Value:</th>
                        <td><input type="text" class="inp-form" name="value" value="<?php if(isset($currency)){ echo $currency->value;} ?>" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Description:</th>
                        <td><textarea name="description"><?php if(isset($currency)){ echo $currency->description;} ?></textarea></td>
			<td></td>
		</tr>
