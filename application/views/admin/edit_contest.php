...
<div id="page-heading"><h1>Edit Contest</h1></div>
...
<tr>
	...
	<td>
		...
		<!--  start step-holder -->
		<div id="step-holder">
			<div class="step-dark-left"><a href="">Edit Contest Details</a></div>
		...
		<?php echo form_open("admin/contest_manager/saveEditedContest"); ?>
			<?php if(isset($contest)){?>
				<input type="hidden" value='<?php echo $contest->id;?>' name='contest_id' />
			<?php }?>		<tr>
			<th valign="top">Title:</th>
			<td><input type="text" name="name" class="inp-form" value="<?php if(isset($contest)){ echo $contest->name;} ?>" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Description:</th>
			<td><textarea name="description" id="content_body_1" ><?php if(isset($contest)){ echo $contest->description;} ?></textarea>
		...
		<tr>
			...
			<td><input type="checkbox" name='enable' <?php if(isset($contest) && $contest->is_active==1){ echo "checked='checked'";} ?> value="1"/>
            </td>
			<td></td>
		</tr>
	...
	<?php echo form_open("admin/contest_manager/saveWinner"); ?>
	<?php if(isset($contest)){?>
	<input type="hidden" value="<?php echo $contest->id; ?>" name="contest_id"/>
	<?php }?>
	<td class="table_right"><div class="step-dark-left1"><a href="">Winner</a></div>
	 <div class="clear"></div>
	 <div class="top_class"><div class="right_input ui-widget">
	...
	<script>
		...
		///    $('#winner').html('<img src="\/global\/flags\/small\/' + data + '.png" alt="" \/> ' + value);
		//alert(data);
		//};
		options = { serviceUrl:'<?php echo base_url(); ?>admin/contest_manager/searchWinner/<?php echo $contest->id; ?>' };
		a = $('#winner').autocomplete(options);
		//alert(a);
		//a.enable();
		});
	</script>
	...
	<!--<script>	
		$( function() {
			...
			$("#tags").autocomplete({ 
				...
				$.ajax({
				    url: '<?php echo base_url(); ?>admin/contest_manager/searchWinner/<?php echo $contest->id; ?>',
				    type: 'POST',
				    data: req,
				    data: {winner_id:$("#tags").val()},
