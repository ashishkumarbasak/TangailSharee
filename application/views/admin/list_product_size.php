		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">Size</th>
					<th class="table-header-repeat line-left minwidth-1">Description</th>
					<th class="table-header-repeat line-left minwidth-1">Catagory</th>
					<th class="table-header-options line-left">Action</th>
				</tr>
    	
    		<?php $i=0; foreach($psizes as $psize){ ?>
	    		<?php if($i%2!='0'){
	    			$class="alternate-row";
	    		}else{
	    			$class="";
				...
				<tr class="<?php echo $class;?>">
					<td><?php echo $i+1; ?></td>
					<td><?php echo $psize->name; ?></td>
					<td><?php echo $psize->description; ?></td>
					<td><?php echo $psize->catagory; ?></td>
					<td class="options-width">
					<a href="<?php echo base_url();?>admin/product_size_manager/editPsize/<?php echo $psize->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="javascript:confirmDelete('<?php echo base_url();?>admin/product_size_manager/deletePsize/<?php echo $psize->id; ?>')" title="Delete" class="icon-2 info-tooltip" ></a>
