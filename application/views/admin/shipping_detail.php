 ...
 <!--Member taber Start-->
    <div id="vtab">
      <ul>
        ...
        <li class="home selected"><a href="<?php echo base_url();?>admin/sales_manager/shippingDetail/<?php echo $order->id;?>">Shipping Detail</a></li>
      ...
      <p style="padding:20px; background: #f5f5f5; border: 1px solid #eee;">

<?php echo $shipadd->first_name;?> <?php echo $shipadd->last_name;?><br />
<?php echo $shipadd->address_line1;?><br />
<?php echo $shipadd->address_line2;?><br />
<?php echo $shipadd->address_line3;?><br />
<?php echo $shipadd->postcode;?><br /> <?php echo $shipadd->city;?><br />
<?php echo $shipadd->state;?><br />
<?php echo $shipadd->country;?>
	...
	<?php if (isset($shipadd)){?>
		...
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form" style="float:left">
			<tr>
				...
				<td>:</td>
				<td>&nbsp;&nbsp;</td>
				<td><?php echo $shipadd->first_name;?></td>
			</tr>
			<tr>
				<th>Last Name</th>
				<td>:</td>
				<td></td>
				<td><?php echo $shipadd->last_name;?></td>
			</tr>
			<tr>
				<th>Address Line 1</th>
				<td>:</td>
				<td></td>
				<td><?php echo $shipadd->address_line1;?></td>
			</tr>
			<tr>
				<th>Address Line 2</th>
				<td>:</td>
				<td></td>
				<td><?php echo $shipadd->address_line2;?></td>
			</tr>
            ...
            <tr>
				...
				<td>:</td>
				<td></td>
				<td><?php echo $shipadd->address_line3;?></td>
			</tr>
			<tr>
				<th>City</th>
				<td>:</td>
				<td></td>
				<td><?php echo $shipadd->city;?></td>
			</tr>
			<tr>
				<th>Postcode</th>
				<td>:</td>
				<td></td>
				<td><?php echo $shipadd->postcode;?></td>
			</tr>
			<tr>
				<th>Region/State</th>
				<td>:</td>
				<td></td>
				<td><?php echo $shipadd->state;?></td>
			</tr>
			<tr>
				<th>Country</th>
				<td>:</td>
				<td></td>
				<td><?php echo $shipadd->country;?></td>
			</tr>
			<tr>
