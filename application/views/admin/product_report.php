...
<div id="page-heading"><h1>
 ...
 <!--Member taber Start-->
    <div id="vtab">
      <ul>
        <li class="home selected"><a href="<?php echo base_url();?>admin/report_manager/product_report">Product Report</a></li>
        <li class="home "><a href="<?php echo base_url();?>admin/report_manager/search_product">Advance Search</a></li>
        </ul>
...
<tr>
	...
	<td>
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
				<tr>
					<th class="table-header-repeat line-left">Product</th>
					<th class="table-header-repeat line-left minwidth-1">Designer</th>
					<th class="table-header-repeat line-left minwidth-1">Timeline</th>
					<th class="table-header-repeat line-left">Sales</th>
					<th class="table-header-repeat line-left minwidth-1">Total</th>
					<th class="table-header-repeat line-left">Designer's Revenue</th>
				</tr>
				...
				<tr class="<?php echo $class;?>">
					...
					<td><?php echo $prod['designer'];?></td>
					<td><?php echo $prod['timeline'];?></td>
					<td><?php echo $prod['qty']; ?></td>
					<td><?php echo $prod['price']* $prod['qty']; ?>&nbsp;&pound;</td>
					<td><?php echo $prod['revenue']; ?>&nbsp;&pound;</td>
