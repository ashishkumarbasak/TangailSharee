 ...
 <!--Member taber Start-->
    <div id="vtab">
       <ul>
        ...
        <li class="home selected"><a href="<?php echo base_url();?>admin/product_manager/stockManager/<?php echo $product->id;?>">DATA</a></li>
...
<tr>
	...
	<td>
		...
		<!--  start step-holder -->
		<div id="step-holder">
			<div class="step-dark-left"><a href="">Price</a></div>
		...
		<!-- start id-form -->
		<?php echo form_open("admin/product_manager/savePrice"); ?>
			<?php if(isset($product)){?>
				<input type="hidden" value='<?php echo $product->id;?>' name='product' />
				<input type="hidden" value='man' name='catagory' />
			<?php }?>
		...
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form" style="float:left">
                    ...
                    <tr>
                            ...
                            <td><input type="text" name="price" class="inp-form" value="<?php echo $product->price ?>" /></td>
                            <td><?php echo form_error('price', '<div class="update_error">', '</div>'); ?></td>
                    </tr>
                      <tr>
                            <th valign="top">Original Price:</th>
                            <td><input type="text" name="original_price" class="inp-form" value="<?php echo $product->original_value; ?>" /></td>
                            <td></td>
                    </tr>  
                    <tr>
                            <th>&nbsp;</th>
	...
	<td>
		...
		<!--  start step-holder -->
		<div id="step-holder">
			<div class="step-dark-left"><a href="">Stock For Man</a></div>
			<!-- <div class="step-dark-right">&nbsp;</div>
			<div class="step-no-off">2</div>
			<div class="step-light-left">Select related products</div>
			<div class="step-light-right">&nbsp;</div>
		...
		<!-- start id-form -->
		<?php echo form_open("admin/product_manager/saveStock"); ?>
			<?php if(isset($product)){?>
				<input type="hidden" value='<?php echo $product->id;?>' name='product' />
				<input type="hidden" value='man' name='catagory' />
			<?php }?>
		...
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form" style="float:left">
                    <?php foreach($sizes as $size){
                        if($size->catagory=='man'){
                    ?>
                        
                    <tr>
                            <th valign="top"><?php echo $size->name; ?>:</th>
                            <td><input type="text" name="stock[<?php echo $size->id ?>]" class="inp-form" value="<?php echo $size->product->join_stock; ?>" /></td>
                            <td></td>
                    </tr>
                        <?php }
                        }
	...
	<td>
		...
		<!--  start step-holder -->
		<div id="step-holder">
			<div class="step-dark-left"><a href="">Stock For Woman</a></div>
			<!-- <div class="step-dark-right">&nbsp;</div>
			<div class="step-no-off">2</div>
			<div class="step-light-left">Select related products</div>
			<div class="step-light-right">&nbsp;</div>
		...
		<?php echo form_open("admin/product_manager/saveStock"); ?>
			<?php if(isset($product)){?>
				<input type="hidden" value='<?php echo $product->id;?>' name='product' />
				<input type="hidden" value='woman' name='catagory' />
			<?php }?>
		
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form" style="float:left">
                    <?php foreach($sizes as $size){
                        if($size->catagory=='woman'){
                    ?>
