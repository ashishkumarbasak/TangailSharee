...
<div id="content">
	...
	<div id="page-heading">
		<ul>
			<?php if($logged_user->role->id==2){
			?>
			<li class="select" ><a href="<?php echo base_url();?>admin/user_manager/index?role_id=4"><?php echo "Customers";?></a></li>
			<?php } else {
				foreach ($roles as $r){ ?>
			
		  <li class="select" ><a href="<?php echo base_url();?>admin/user_manager/index?role_id=<?php echo $r->id;?>"><?php echo $r->name;?></a></li>
		  <?php
			}
		  }?>
		 </ul>
		<div class="clear"></div>
		<h1><?php echo $role->name; ?><span><a href="<?php echo base_url();?>admin/user_manager/addUser/<?php echo $role->id;?>">Add New</a></span></h1>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<?php echo form_open('admin/user_manager/filter_index/'.$role->id,"name='filter_form' id='filter_form'"); ?>
				...
				$(document).ready(function() {
					$('#filter_submit').click(function(){
							$('#filter_form input[name=username]').val($('#filter_username').val());
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">Username</th>
    			...
    			<tr class="">
					...
					<td>&nbsp;</td>
					<td><input type='text' id='filter_username' /></td>
    		...
    		<?php $i=0; foreach($role->user as $user){ ?>
	    		<?php if($i%2!='0'){
	    			$class="alternate-row";
	    		}else{
	    			$class="";
				...
				<tr class="<?php echo $class;?>">
					...
					<a href="<?php echo base_url();?>admin/user_manager/editUser/<?php echo $user->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="javascript:confirmDelete('<?php echo base_url();?>admin/user_manager/deleteUser/<?php echo $user->id; ?>')" title="Delete" class="icon-2 info-tooltip" ></a>
