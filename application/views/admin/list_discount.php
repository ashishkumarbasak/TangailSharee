...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
    		...
    		<?php $i=0; foreach($discounts as $discount){ ?>
	    		<?php if($i%2!='0'){
	    			$class="alternate-row";
	    		}else{
	    			$class="";
				...
				<tr class="<?php echo $class;?>">
					...
					<td><?php echo date("j/n/Y",$discount->start_date); ?></td>
					<td><?php echo date("j/n/Y",$discount->end_date); ?></td>
					<td class="options-width">
					<a href="<?php echo base_url();?>admin/coupon_manager/editCoupon/<?php echo $discount->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="javascript:confirmDelete('<?php echo base_url();?>admin/discount_manager/deleteDiscount/<?php echo $discount->id; ?>')" title="Delete" class="icon-2 info-tooltip" ></a>
