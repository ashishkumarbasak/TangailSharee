		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">Color Title</th>
					<th class="table-header-options line-left">Action</th>
				</tr>
    	
    		<?php $i=0; foreach($pcolors as $pcolor){ ?>
	    		<?php if($i%2!='0'){
	    			$class="alternate-row";
	    		}else{
	    			$class="";
				...
				<tr class="<?php echo $class;?>">
					<td><?php echo $i+1; ?></td>
					<td><?php echo $pcolor->name; ?></td>
					<td class="options-width">
					<a href="<?php echo base_url();?>admin/product_color_manager/editPcolor/<?php echo $pcolor->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="javascript:confirmDelete('<?php echo base_url();?>admin/product_color_manager/deletePcolor/<?php echo $pcolor->id; ?>')" title="Delete" class="icon-2 info-tooltip" ></a>
