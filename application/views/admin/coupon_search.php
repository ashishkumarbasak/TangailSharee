...
<div id="page-heading"><h1>
 ...
 <!--Member taber Start-->
    <div id="vtab">
      <ul>
        <li class="home "><a href="<?php echo base_url();?>admin/report_manager/coupon_report">Coupon Report</a></li>
        <li class="home selected"><a href="<?php echo base_url();?>admin/report_manager/search_coupon">Advance Search</a></li>
        </ul>
	...
	<td>
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">No of Coupon Used</th>
				...
				<tr class="<?php echo $class;?>">
					<td><?php echo date("j-m-Y",strtotime($prod['start_date']));?></td>
					<td><?php echo date("j-m-Y",strtotime($prod['end_date']));?></td>
					<td><?php echo $prod['coupon_used'];?></td>
