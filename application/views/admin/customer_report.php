...
<div id="page-heading"><h1>
 ...
 <!--Member taber Start-->
    <div id="vtab">
      <ul>
        <li class="home selected"><a href="<?php echo base_url();?>admin/report_manager/customer_report">Customer Report</a></li>
        <li class="home "><a href="<?php echo base_url();?>admin/report_manager/search_customer">Advance Search</a></li>
        </ul>
...
<tr>
	...
	<td >
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">No. Sales</th>
				...
				<tr class="<?php echo $class;?>">
					<td><?php echo $prod['country']?></td>
					<td><?php echo $prod['quantity'];?></td>
					<td><?php echo $prod['total'];?>&nbsp;&pound;</td>
				</tr>
			<?php $i++;} ?>
		</table>
		<?php }else{
	...
	<div class="report_graph"><img src="<?php echo base_url();?>/temp/testpie.png"/></div>
	<div class="clear"></div>
