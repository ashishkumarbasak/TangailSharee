...
<div id="page-heading"><h1>Add Contest</h1></div>
...
<tr>
	...
	<td class="table_left">
		...
		<!--  start step-holder -->
		<div id="step-holder">
			<div class="step-dark-left"><a href="">Add Contest Details</a></div>
		...
		<?php echo form_open("admin/contest_manager/saveContest"); ?>
		<tr>
			<th valign="top">Title:</th>
			<td><input type="text" name="name" class="inp-form" value="<?php echo $this->input->post('title');?>" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Description:</th>
			<td><textarea name="description" id="content_body_1" ></textarea>
			<?php echo display_ckeditor($ckeditor); ?>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Start Date:</th>
			<td><input type="text" class="inp-form" name="start_date"  id='start_date' value="<?php echo $this->input->post('start_date');?>" />
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="end_date" id='end_date' value="<?php echo $this->input->post('end_date');?>" />
		...
		<tr>
			...
			<td><input type="checkbox" name='enable'  value="1"/>
            </td>
			<td></td>
		</tr>
	...
	<td class="table_right"><div class="step-dark-left1"><a href="">Winner</a></div>
	 <div class="clear"></div>
	 <div class="top_class"><div class="right_input">
	<input type="text" class="inp-form" name="winner" id="winner" value="" />
	</div>
	<div class="clear"></div>
