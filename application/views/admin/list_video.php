		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left">User</th>
    		...
    		<?php $i=0; foreach($videos as $video){ ?>
				...
				<tr class="<?php echo $class;?>">
					...
					<td><?php echo unix_to_human($video->date); ?></td>
					<td><?php echo $video->user->first_name.' '.$video->user->last_name; ?></td>
					<td class="options-width">
					<a href="<?php echo base_url();?>admin/video_manager/editVideo/<?php echo $video->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="javascript:confirmDelete('<?php echo base_url();?>admin/video_manager/deleteVideo/<?php echo $video->id; ?>')" title="Delete" class="icon-2 info-tooltip" ></a>
