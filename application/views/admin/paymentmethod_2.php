...
<div id="page-heading"><h1>
 ...
 <!--Member taber Start-->
    <div id="vtab">
      <ul>
        <li class="home "><a href="<?php echo base_url();?>admin/setting_manager/paymentcredit">Authorize.net</a></li>
        <li class="home selected"><a href="<?php echo base_url();?>admin/setting_manager/paymentpaypal">Paypal</a></li>
        </ul>
...
<tr>
	...
	<tr valign="top">
	<td>
	<?php echo form_open("admin/setting_manager/paymentpaypal"); ?>
