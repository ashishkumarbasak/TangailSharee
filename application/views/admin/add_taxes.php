...
<tr>
	...
	<td class="table_left">
		...
		<?php echo form_open("admin/setting_manager/saveTaxes"); ?>
		<?php if(isset($tax)){?>
				<input type="hidden" value='<?php echo $tax->id;?>' name='tax_id' />
			<?php }?>	
		<tr>
			<th valign="top">Name:</th>
			<td><input type="text" name="name" class="inp-form" value="<?php if (isset($tax)){ echo $tax->name;}?>" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Apply to:</th>
			<td><input type="text" name="apply_to" class="inp-form" value="<?php if (isset($tax)){ echo $tax->apply_to;}?>" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Rate</th>
			<td><input type="text" name="rate" class="inp-form" value="<?php if (isset($tax)){ echo $tax->rate;}?>" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Default:</th>
			<td><input type="checkbox" name='default' <?php if(isset($tax) && $tax->default==1){ echo "checked='checked'";} ?> value="1"/>
            </td>
			<td></td>
		</tr>
