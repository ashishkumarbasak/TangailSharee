...
<?php
	 $button='Add Your Page';
	 $button1='Edit Your Page';
	 $bar='Add Page Details';
	 $bar1='Edit Page Details';
	 if (isset($page)){
?>
<div id="page-heading"><h1><?php echo $button1;?></h1></div>
<?php 
	 }
	 else {
?>
<div id="page-heading"><h1><?php echo $button;}?></h1></div>
...
<tr>
	...
	<?php echo form_open("admin/cms_manager/savePage"); ?>
		<?php if(isset($page)){?>
	...
	<td>
		...
		<div id="step-holder">
			...
			?>
			<div class="step-dark-left"><?php echo $bar;}?></div>
		...
		<tr>
			...
			<td><input type="text" name="title" class="inp-form" value="<?php if(isset($page)){ echo $page->title;} else { echo $this->input->post('title');} ?>" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Body:</th>
			<td><textarea name="content" id="content_body_1" ><?php if(isset($page)){ echo $page->content;} else {  echo $this->input->post('content'); }?></textarea>
	...
	<td class="table_right"><div class="step-dark-left1"><a href="">Publish</a></div>
	 <div class="clear"></div>
	 <div class="button2"><a href="#"><img src="<?php echo base_url(); ?>adm/images/forms/Preview.gif"  alt="" /></a></div>
	 <div class="button1"><input type="submit" class="form-draft" name="save_draft" value="save_draft"></div>
	 <div class="top_class2"><div class="right_input">
	 <select  class="styledselect_form_1" name="user_id">
			<option value=""></option>
		</select>
	</div>
	<div class="clear"></div>
	<div class="button3"><a href="">Move to trash</a></div>
	<div class="button1"><input type="submit" class="form-publish" name="publish" value="publish"></div>
	<div class="clear"></div>
	</div>
	</td>
</tr>
