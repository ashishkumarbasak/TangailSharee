...
<div id="page-heading"><h1>
 ...
 <!--Member taber Start-->
    <div id="vtab">
      <ul>
        <!-- <li class="home" ><a href="<?php echo base_url();?>admin/sales_manager/refunddetail/<?php echo $order->id;?>">Refund details</a></li> //-->
        <li class="home selected"><a href="<?php echo base_url();?>admin/sales_manager/refundHistory/<?php echo $order->id;?>">Refund History</a></li>
       </ul>
...
<tr>
	...
	<td>
		<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
				<tr>
					<th class="table-header-repeat">Order ID</th>
                    <th class="table-header-repeat">Product ID</th>
					<th class="table-header-repeat">Date Added</th>
					<th class="table-header-repeat">Comment</th>
					<th class="table-header-repeat">Status</th>
					<th class="table-header-repeat">Customer Notified</th>
				</tr>
				<?php $sub_total = 0; $i=0; 
				...
				<tr class="<?php echo $class;?>">
					...
					<td><?php echo nl2br($prod->comment); ?></td>
			...
			<?php $i++; } ?>
				...
				<table border="0" cellpadding="0" cellspacing="0"  id="id-form" style="display:none;">
		<?php echo form_open("admin/sales_manager/saverhistory"); ?>
		...
		<td>	
		 <input type="checkbox" name='notity' value="1"/>
		</td>
		<td></td>
		</tr>
		<tr>
