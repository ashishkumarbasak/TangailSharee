 ...
 <!--Member taber Start-->
    <div id="vtab">
      ...
      <li class="home "><a href="<?php echo base_url();?>admin/coupon_manager/editCoupon/<?php echo $coupon->id;?>">General</a></li>
        <li class="home selected"><a href="<?php echo base_url();?>admin/coupon_manager/couponhistory/<?php echo $coupon->id;?>">Coupon History</a></li>
       </ul>
...
<tr>
	...
	<tr valign="top">
	<td>Total coupon used: <?php echo count($order->all);?>&nbsp;/&nbsp;<?php echo $coupon->uses_coupon?><br/><br/>
	<?php if (count($order->all)>0){?>
		<table border="0" width="100%" cellpadding="0" cellspacing="0" id="product-table">
				<tr>
					<th class="table-header-repeat line-left">Order Id</th>
					<th class="table-header-repeat line-left minwidth-1">Customer</th>
					<th class="table-header-repeat line-left">Amount</th>
				...
				<tr class="<?php echo $class;?>">
					...
					<td><?php echo $prod->user->id;?></td>
					<td><?php echo $prod->total_amount; ?></td>
					<td><?php echo $prod->order_date; ?></td>
				</tr>
