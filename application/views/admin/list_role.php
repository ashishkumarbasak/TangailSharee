		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">Role Title</th>
    		...
    		<?php $i=0; foreach($roles as $role){ ?>
				...
				<tr class="<?php echo $class;?>">
					...
					<a href="<?php echo base_url();?>admin/role_manager/editRole/<?php echo $role->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="javascript:confirmDelete('<?php echo base_url();?>admin/role_manager/deleteRole/<?php echo $role->id; ?>')" title="Delete" class="icon-2 info-tooltip" ></a>
