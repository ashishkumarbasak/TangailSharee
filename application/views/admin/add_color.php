...
<link type="text/css" href="<?php echo base_url(); ?>css/colorpicker.css" rel="stylesheet">
<link href="<?php echo base_url(); ?>css/layout.css" type="text/css" media="screen" rel="stylesheet">	
...
<?php
	 $button='Add Color';
	 $button1='Edit Color';
	 $bar='Add Color Details';
	 $bar1='Edit Color Details';
	 if (isset($pcolor)){
	?>
...
<tr>
	...
	<td>
		...
		<?php echo form_open("admin/product_color_manager/savePcolor"); ?>
			<?php if(isset($pcolor)){?>
				<input type="hidden" value='<?php echo $pcolor->id;?>' name='pcolor_id' />
			<?php }?>
		<tr>
			<th valign="top">Color Title:</th>
			<td><input type="text" name="name" class="inp-form" value="<?php if(isset($pcolor)){ echo $pcolor->name;} ?>" /></td>
			<td></td>
		</tr>
                <tr>
			<th valign="top">Select Color:</th>
			<td><input type="text" name="color_code" id="color_code" class="inp-form" value="<?php if(isset($pcolor)){ echo $pcolor->code;} ?>" /></td>
			<td></td>
		</tr>
		<script>
