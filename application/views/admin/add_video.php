...
<?php
	 $button='Add Video';
	 $button1='Edit Video';
	 $bar='Add Video Details';
	 $bar1='Edit Video Details';
	 if (isset($video)){
?>
...
<tr>
	...
	<td>
		...
		<?php echo form_open("admin/video_manager/saveVideo"); ?>
			<?php if(isset($video)){?>
				<input type="hidden" value='<?php echo $video->id;?>' name='video_id' />
			<?php }?>
		<tr>
			<th valign="top">Title:</th>
			<td><input type="text" name="title" class="inp-form" value="<?php if(isset($video)){ echo $video->title;} ?>" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Description:</th>
			<td><textarea rows="" cols="" class="form-textarea" name="description"><?php if(isset($video)){ echo $video->description;} ?></textarea></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Embeded Link:</th>
			<td><input type="text" class="inp-form" name="link" value="<?php if(isset($video)){ echo $video->link;} ?>" />
            </td>
			<td></td>
		</tr>
