...
<?php
	 ...
	 $button1='Edit Terms & Conditions';
	 $bar='Add Page Details';
	 $bar1='User Registration terms';
	 if (isset($page)){
?>
...
<tr>
	...
	<td>
		...
		<?php echo form_open("admin/setting_manager/saveTerms"); ?>
			<?php if(isset($page)){?>
				<input type="hidden" value='<?php echo $page->id;?>' name='id' />
			<?php }?>
		<tr>
			<th valign="top">Body:</th>
			<td><textarea name="terms" id="content_body_1" ><?php if(isset($page)){ echo $page->terms;} ?></textarea>
