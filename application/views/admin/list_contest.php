...
<div id="content">
	...
	<div id="page-heading">
		...
		<h1>CONTESTS<span><a href="<?php echo base_url();?>admin/contest_manager/addContest">Add New</a></span></h1>
	</div>
	<!-- end page-heading -->
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<?php echo form_open('admin/contest_manager/filter_index/',"name='filter_form' id='filter_form'"); ?>
				...
				$(document).ready(function() {
					$('#filter_submit').click(function(){
							...
							$('#filter_form input[name=winner]').val($('#filter_winner').val());
							$('#filter_form').submit();
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1">Winner</th>
					<th class="table-header-repeat line-left">Start Date</th>
					<th class="table-header-repeat line-left">End Date</th>
    		...
    		<?php $i=0; $time = time(); foreach($contests as $contest){ ?>
				...
				<tr class="<?php echo $class;?>">
					<td><?php echo $i+1; ?></td>
					<td <?php if(($contest->is_active == '1') && ($contest->start_date < $time) && ($contest->end_date > $time)) {
						echo "class='val_error'"; } ?>><p><?php echo $contest->name; ?></p></td>
					<td><?php echo $contest->winner; ?></td>
					<td><?php echo date("d/m/Y",$contest->start_date); ?></td>
					<td><?php echo date("d/m/Y",$contest->end_date); ?></td>
					<td class="options-width">
					<a href="<?php echo base_url();?>admin/contest_manager/editContest/<?php echo $contest->id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
					<a href="javascript:confirmDelete('<?php echo base_url();?>admin/contest_manager/deleteContest/<?php echo $contest->id; ?>')" title="Delete" class="icon-2 info-tooltip" ></a>
					<a href="<?php echo base_url();?>admin/contest_manager/contestGraphics/<?php echo $contest->id; ?>">Submitted Graphics</a>
