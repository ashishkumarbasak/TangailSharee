...
<?php
	 ...
	 $button1='Edit Product Attribute';
	 $bar='Add Product Attribute Details';
	 $bar1='Edit Product Attribute Details';
	 if (isset($video)){
?>
...
<tr>
	...
	<td>
		...
		<?php echo form_open("admin/attribute_manager/saveAttribute"); ?>
			<?php if(isset($attribute)){?>
				<input type="hidden" value='<?php echo $attribute->id;?>' name='attribute_id' />
			<?php }?>
		<tr>
			<th valign="top">Title:</th>
			<td><input type="text" name="title" class="inp-form" value="<?php if(isset($attribute)){ echo $attribute->title;} ?>" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Description:</th>
			<td><textarea rows="" cols="" class="form-textarea" name="description"><?php if(isset($attribute)){ echo $attribute->description;} ?></textarea></td>
			<td></td>
		</tr>
