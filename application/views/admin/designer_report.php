...
<div id="page-heading"><h1>
 ...
 <!--Member taber Start-->
    <div id="vtab">
      <ul>
        <li class="home selected"><a href="<?php echo base_url();?>admin/report_manager/designer_report">Designer Report</a></li>
        <li class="home "><a href="<?php echo base_url();?>admin/report_manager/search_designer">Advance Search</a></li>
        </ul>
