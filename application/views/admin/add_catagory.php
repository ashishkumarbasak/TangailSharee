...
<?php
	 $button='Add Catagory';
	 $button1='Edit Catagory';
	 $bar='Add Catagory Details';
	 $bar1='Edit Catagory Details';
	 if (isset($catagory)){
?>
...
<tr>
	...
	<td>
		...
		<?php echo form_open("admin/catagory_manager/saveCatagory"); ?>
			<?php if(isset($catagory)){?>
				<input type="hidden" value='<?php echo $catagory->id;?>' name='catagory_id' />
			<?php }?>
		<tr>
			<th valign="top">Title:</th>
			<td><input type="text" name="name" class="inp-form" value="<?php if(isset($catagory)){ echo $catagory->name;} ?>" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Description:</th>
			<td><textarea rows="" cols="" class="form-textarea" name="description"><?php if(isset($catagory)){ echo $catagory->description;} ?></textarea></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">No. of Products:</th>
			<td><input type="text" class="inp-form" name="no_of_products" value="<?php if(isset($catagory)){ echo $catagory->no_of_products;} ?>" />
            </td>
			<td></td>
		</tr>
