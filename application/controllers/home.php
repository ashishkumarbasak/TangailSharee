...
class Home extends MY_Controller 
{
    ...
    function getNewProducts()
	{
    	...
    	//$product->where_in('id',$prod); //c
		//$product->order_by('date_added','desc'); //c
		//$product->limit(12)->get(); //c
    ...
    function getSaleProducts()
	{
    	...
    	//$product->where_in('id',$prod); //c
		//$product->where('original_value >','0'); //c
    	//$product->order_by('date_added','desc'); //c
		//$product->limit(12)->get(); //c
